...
@section("add")
    <a href="{{url("admins/teacher/my-course/course/$result->offered_courses_id")}}">
            ...
            @foreach($offeredCourses as $offeredCourse)
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="ct1_obtained" class="form-control" id="ct1_obtained"
                           value="{{old("ct1_obtained", $result->ct1_obtained)}}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="ct2_obtained" class="form-control" id="ct2_obtained"
                           value="{{old("ct2_obtained", $result->ct2_obtained)}}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="ct3_obtained" class="form-control" id="ct3_obtained"
                           value="{{old("ct3_obtained", $result->ct3_obtained)}}">
