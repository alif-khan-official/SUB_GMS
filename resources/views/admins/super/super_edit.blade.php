                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{url("admins/super/$super->id/edit")}}" class="btn btn-primary btn-flat">Edit
                                        Profile</a>
                                </div>
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        ...
                        <table id="table" class="table table-bordered table-striped">
                            ...
                            <form action="{{url("admins/super/$super->id")}}" method="post">
                                @csrf
                                @method('PATCH')
                                <div class="box-body">

                                    <div class="form-group">
                                        <label for="users_id">Super Admin ID</label>
                                        <input type="text" name="users_id" class="form-control" id="users_id"
                                               value="{{old("users_id", $super->users_id)}}">

                                        @if($errors->has('users_id')) <p
                                                style="color:red;"> @foreach( $errors->get('users_id') as $error) {{ $error }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="password" class="form-control" id="password"
                                               value="{{old($super->password)}}">

                                        @if($errors->has('password')) <p
                                                style="color:red;"> @foreach( $errors->get('password') as $error) {{ $error }}
                                            <br/> @endforeach </p> @endif
                                    </div>
