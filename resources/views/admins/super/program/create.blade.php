...
@section("tr1")
    <form action="{{url('admins/super/program')}}" method="post">
        @csrf
        <div class="box-body">
            <div class="form-group">
                <label for="prog_code">Program Code</label>
                <input type="text" name="prog_code" class="form-control" id="prog_code" value="{{old("prog_code")}}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="prog_name" class="form-control" id="prog_name" value="{{old("prog_name")}}">
